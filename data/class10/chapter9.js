...
const class10Chapter9 = {
    ...
    broad: [
        { topic: "Tools for Construction", content: "Compass: for arcs, circles, marking equal lengths, bisecting lines/angles. Ruler: for drawing straight lines and measuring distances. Protractor: for measuring angles when required." },
        { topic: "Line Division", content: "Internal or external division of a line in a given ratio using compass and ruler. Helps in constructing similar triangles or scaled figures." },
        { topic: "Triangle Construction", content: "Construct triangle using given sides (SSS), base and angles (SAS/ASA), or perimeter with base. Use arcs to find intersections accurately." },
        { topic: "Tangent Construction", content: "Construct tangents from external point by drawing line to center, finding midpoint, drawing auxiliary circle, and intersecting tangent points." },
        { topic: "Angle and Perpendicular Bisectors", content: "Bisect angles by intersecting arcs. Draw perpendiculars from point to line using arcs from point and intersections. Perpendicular bisector divides line into equal halves." }
    ],
    broadTest: [
        { question: "Tools mainly used for constructions:", options: ["Ruler only", "Compass only", "Ruler and Compass", "Protractor only"], correct: 2 },
        { question: "Bisector of an angle divides it into:", options: ["Two equal angles", "Two unequal angles", "Three angles", "Cannot say"], correct: 0 },
        { question: "Perpendicular bisector of line segment divides it into:", options: ["Equal halves", "Unequal halves", "Depends", "None"], correct: 0 },
        { question: "Triangles similar by proportional sides and included angle:", options: ["AA", "SAS", "SSS", "ASA"], correct: 1 },
        { question: "External division of line segment uses:", options: ["Marking points on extension and parallel line", "Bisector", "Tangent", "Angle bisector"], correct: 0 },
        { question: "Arc intersections are used for:", options: ["Finding points", "Measuring", "Drawing circles", "None"], correct: 0 },
        { question: "Importance of construction:", options: ["Precision", "Geometry knowledge", "Practical skills", "All of these"], correct: 3 },
        { question: "Construction of tangent involves:", options: ["Line to center and midpoint circle", "Bisector only", "Perpendicular only", "None"], correct: 0 },
        { question: "Triangle construction with SSS uses:", options: ["Arcs from base ends", "Bisector", "Tangent", "Parallel line"], correct: 0 },
        { question: "Common mistakes in construction include:", options: ["Incorrect arcs", "Wrong radii", "Unlabeled points", "All of the above"], correct: 3 }
    ]
};
