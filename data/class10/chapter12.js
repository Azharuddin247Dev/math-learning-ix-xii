...
const class10Chapter12 = {
    ...
    broad: [
        { topic: "Basic ratios", content: "sinθ = opposite/hypotenuse, cosθ = adjacent/hypotenuse, tanθ = opposite/adjacent" },
        { topic: "Reciprocal ratios", content: "cosecθ = 1/sinθ, secθ = 1/cosθ, cotθ = 1/tanθ" },
        { topic: "Trigonometric identities", content: "sin²θ + cos²θ = 1; 1 + tan²θ = sec²θ; 1 + cot²θ = cosec²θ" },
        { topic: "Complementary angles", content: "sin(90−θ) = cosθ, cos(90−θ) = sinθ, tan(90−θ) = cotθ, cot(90−θ) = tanθ" },
        { topic: "Heights & distances", content: "tanθ = opposite/adjacent; sinθ = opposite/hypotenuse; cosθ = adjacent/hypotenuse" },
        { topic: "Laws", content: "Law of Sines: a/sinA = b/sinB = c/sinC; Law of Cosines: c² = a² + b² − 2ab cosC" },
        { topic: "Standard triangles", content: "30°-60°-90° triangle: ratios 1:√3:2; 45°-45°-90° triangle: ratios 1:1:√2" },
        { topic: "Applications", content: "Navigation, surveying, engineering, astronomy, construction" }
    ],
    broadTest: [
        { question: "tanθ =", options: ["Opposite/Adjacent", "Adjacent/Opposite", "Hypotenuse/Opposite", "Hypotenuse/Adjacent"], correct: 0 },
        { question: "cosecθ =", options: ["1/sinθ", "1/cosθ", "1/tanθ", "tanθ"], correct: 0 },
        { question: "Law of Sines formula:", options: ["a/sinA = b/sinB = c/sinC", "a+b+c", "a²+b²=c²", "tanA=opposite/adjacent"], correct: 0 },
        { question: "Law of Cosines formula:", options: ["c² = a² + b² − 2ab cosC", "a² + b² = c²", "c = a+b", "tanC = opposite/adjacent"], correct: 0 },
        { question: "sin²θ + cos²θ =", options: ["1", "0", "tan²θ", "2"], correct: 0 },
        { question: "Angle of elevation uses:", options: ["Horizontal", "Vertical", "Slope", "None"], correct: 0 },
        { question: "Angle of depression uses:", options: ["Horizontal", "Vertical", "Slope", "None"], correct: 0 },
        { question: "cotθ =", options: ["1/tanθ", "1/sinθ", "cosθ", "tanθ"], correct: 0 },
        { question: "secθ =", options: ["1/cosθ", "1/sinθ", "1/tanθ", "cosθ"], correct: 0 },
        { question: "Standard triangle for sin30°:", options: ["30°-60°-90°", "45°-45°-90°", "60°-30°-90°", "None"], correct: 0 }
    ]
};
