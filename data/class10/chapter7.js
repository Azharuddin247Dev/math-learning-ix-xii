...
const class10Chapter7 = {
    ...
    broad: [
        { topic: "Chord Properties", content: "Perpendicular from the center bisects the chord; equal chords are equidistant from the center." },
        { topic: "Tangent Properties", content: "Tangent is perpendicular to radius at point of contact; two tangents from external point are equal in length." },
        { topic: "Cyclic Quadrilaterals", content: "Quadrilaterals with vertices on a circle; opposite angles sum to 180°. Useful in angle calculations." },
        { topic: "Intersecting Chords Theorem", content: "If two chords intersect, the product of segments of one chord equals the product of segments of the other." },
        { topic: "Circle Equations", content: "Equation of circle with center (h,k) and radius r: (x−h)² + (y−k)² = r²; helps in coordinate geometry problems." }
    ],
    broadTest: [
        { question: "Two tangents from external point are:", options: ["Unequal", "Equal", "Parallel", "Perpendicular"], correct: 1 },
        { question: "Angle in semicircle is always:", options: ["60°", "90°", "120°", "45°"], correct: 1 },
        { question: "Perpendicular from center to chord does:", options: ["Bisects chord", "Divides diameter", "Equal to radius", "None"], correct: 0 },
        { question: "Cyclic quadrilateral property:", options: ["Opposite angles sum 180°", "All angles equal", "All sides equal", "Diagonals equal"], correct: 0 },
        { question: "Intersecting chords theorem states:", options: ["Sum of segments equal", "Product of segments equal", "Difference of segments equal", "None"], correct: 1 },
        { question: "Equation of circle radius r, center (0,0):", options: ["x²+y²=r", "x²+y²=r²", "(x−r)²+(y−r)²=r²", "x²+y²=2r"], correct: 1 },
        { question: "Arc of circle is:", options: ["Line segment", "Part of circumference", "Chord", "Radius"], correct: 1 },
        { question: "Sector of circle is:", options: ["Region between two radii and arc", "Line segment", "Chord", "Angle only"], correct: 0 },
        { question: "Tangent is perpendicular to:", options: ["Chord", "Radius", "Diameter", "Secant"], correct: 1 },
        { question: "Equal chords are:", options: ["Equidistant from center", "Same length always", "Parallel", "None"], correct: 0 }
    ]
};
