...
const class10Chapter2 = {
    ...
    broad: [
        { topic: "Overview of Mensuration", content: "Mensuration involves formulas for calculating surface area and volume of 3D shapes like spheres, hemispheres, cones, frustums, cylinders, cuboids, and cubes." },
        { topic: "Cones and Frustums", content: "Slant height is calculated using Pythagoras theorem. CSA and total SA formulas involve slant height. Volume formulas use height directly." },
        { topic: "Cylinders, Cuboids, and Cubes", content: "CSA of cylinder is lateral area only; total SA adds top and bottom. Cuboid and cube formulas are straightforward, using length, breadth, and height or side." },
        { topic: "Units and Conversion", content: "Surface area in square units, volume in cubic units. Convert units consistently when solving problems." },
        { topic: "Problem Solving Tips", content: "Always draw diagrams, label dimensions, choose correct formula, calculate carefully, and check units." }
    ],
    broadTest: [
        { question: "Total surface area of sphere radius r:", options: ["4πr²", "2πr²", "3πr²", "πr²"], correct: 0 },
        { question: "Volume of hemisphere radius r:", options: ["(4/3)πr³", "(2/3)πr³", "πr³", "2πr²"], correct: 1 },
        { question: "Curved surface area of cone:", options: ["πr²", "πrl", "πr(l+r)", "2πr²"], correct: 1 },
        { question: "Slant height formula for cone:", options: ["√(r²+h²)", "r+h", "r−h", "h/r"], correct: 0 },
        { question: "CSA of cylinder:", options: ["πr²h", "2πrh", "πr(h+r)", "2πr²h"], correct: 1 },
        { question: "Volume of cuboid:", options: ["l+b+h", "l×b×h", "2(lb+bh+hl)", "l²+b²+h²"], correct: 1 },
        { question: "Surface area of cube:", options: ["a³", "6a²", "3a²", "2a²"], correct: 1 },
        { question: "Units of volume:", options: ["cm²", "m²", "m³", "cm"], correct: 2 },
        { question: "Applications of mensuration include:", options: ["Construction", "Packaging", "Design", "All of the above"], correct: 3 },
        { question: "Problem-solving tip:", options: ["Guess answer", "Use diagram & formula", "Ignore units", "Round randomly"], correct: 1 }
    ]
};
