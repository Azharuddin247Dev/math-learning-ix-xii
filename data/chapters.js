...
const classChapters = {
    ...
    12: [
        ...
        { id: 8, name: "Applications of Integrals", description: "Area enclosed by curve, volume of solid, work done, average value" },
        { id: 9, name: "Differential Equations", description: "Formation, first-order first-degree equations, separation of variables, homogeneous, linear type" },
        { id: 10, name: "Vectors", description: "Representation, addition, scalar multiplication, dot and cross product, applications" },
        { id: 11, name: "Three-Dimensional Geometry", description: "Direction cosines, direction ratios, line equations, plane equations, angles, distances" },
        { id: 12, name: "Probability", description: "Probability distribution, mean, variance, binomial distribution, conditional probability, Bayes’ theorem" },
        { id: 13, name: "Statistics", description: "Regression, correlation, applications" },
        { id: 14, name: "Linear Programming", description: "Linear inequalities, graphical solution, word problems in two variables" }
    ]
};
