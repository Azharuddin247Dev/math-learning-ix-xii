...
const class9Chapter14 = {
    ...
    broad: [
        { question: "State the formula for mean of grouped data.", answer: "Mean = (Σf·x)/Σf" },
        { question: "State the formula for median of grouped data.", answer: "Median = L + ((N/2 − CF)/f)·h" },
        { question: "State the formula for mode of grouped data.", answer: "Mode = L + ((f1−f0)/(2f1−f0−f2))·h" },
        { question: "What is cumulative frequency?", answer: "Sum of frequencies of all classes up to a given class." },
        { question: "Applications of statistics.", answer: "Economics, business, social science, research, sports analysis." },
        { question: "Representation of data.", answer: "Tables, charts, graphs, and diagrams." }
    ],
    broadTest: [
        { question: "Mean of 10, 15, 20, 25:", options: ["17.5", "18", "20", "19"], correct: 0 },
        { question: "Median of 2, 4, 6, 8, 10:", options: ["4", "5", "6", "8"], correct: 2 },
        { question: "Mode of 1, 2, 2, 3, 4:", options: ["1", "2", "3", "4"], correct: 1 },
        { question: "Cumulative frequency of last class:", options: ["0", "Equal to total frequency", "Equal to mean", "Equal to median"], correct: 1 },
        { question: "Histogram represents:", options: ["Frequency distribution", "Mean", "Median", "Mode"], correct: 0 },
        { question: "Standard deviation of identical values is:", options: ["0", "1", "Equal to mean", "Cannot be determined"], correct: 0 }
    ]
};
