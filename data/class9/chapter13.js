...
const class9Chapter13 = {
    ...
    broad: [
        { question: "State the formula for surface area of prism.", answer: "Surface area = Lateral surface area + 2 × Base area." },
        { question: "State the formula for volume of pyramid.", answer: "Volume = (1/3) × Base area × Height." },
        { question: "Total surface area of hemisphere.", answer: "3πr²." },
        { question: "Volume of frustum of cone.", answer: "Volume = (1/3)πh(R² + r² + Rr)." },
        { question: "Units of surface area and volume.", answer: "Surface area in m²/cm², volume in m³/cm³." },
        { question: "Slant height using Pythagoras theorem.", answer: "l = √(r²+h²) or l = √((R−r)² + h²)." },
        { question: "Volume of combination of solids.", answer: "Add individual volumes." },
        { question: "Surface area of combination of solids.", answer: "Sum exposed surfaces; subtract joining faces." }
    ],
    broadTest: [
        { question: "Total surface area of a sphere with radius 7 cm:", options: ["154 cm²", "615.44 cm²", "196 cm²", "308 cm²"], correct: 1 },
        { question: "Volume of cone with r=3 cm, h=4 cm:", options: ["12π", "4π", "πr²h", "16π"], correct: 0 },
        { question: "Curved surface area of hemisphere with r=5 cm:", options: ["50π", "25π", "100π", "75π"], correct: 0 },
        { question: "Slant height of cone with r=3 cm, h=4 cm:", options: ["5 cm", "7 cm", "6 cm", "4 cm"], correct: 0 },
        { question: "Volume of frustum with R=6 cm, r=4 cm, h=9 cm:", options: ["324π", "360π", "180π", "288π"], correct: 0 },
        { question: "Units of surface area:", options: ["cm³", "cm²", "m³", "m²"], correct: 1 }
    ]
};
