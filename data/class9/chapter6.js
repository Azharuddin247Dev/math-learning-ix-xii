...
const class9Chapter6 = {
    ...
    broad: [
        { question: "Define rational algebraic expression.", answer: "A fraction in which both numerator and denominator are polynomials and the denominator is not zero." },
        { question: "What is the domain of a rational expression?", answer: "All values of the variable for which the denominator is not zero." },
        { question: "State rules for adding/subtracting rational expressions.", answer: "Add/subtract only if denominators are same; otherwise, find LCM of denominators first." },
        { question: "State rules for multiplying/dividing rational expressions.", answer: "Multiply/divide numerators and denominators and simplify common factors." },
        { question: "Explain how to reduce a rational expression to lowest terms.", answer: "Factor numerator and denominator completely and cancel common factors." },
        { question: "Why is domain important in rational expressions?", answer: "To avoid division by zero and undefined expressions." },
        { question: "Give practical applications of rational expressions.", answer: "Used in algebraic problem solving, ratios, rates, and engineering calculations." }
    ],
    broadTest: [
        { question: "A rational algebraic expression is:", options: ["A polynomial", "A fraction of polynomials", "A monomial", "A binomial"], correct: 1 },
        { question: "Domain of 1/(x−5) is:", options: ["x=5", "x≠5", "x>5", "x<5"], correct: 1 },
        { question: "When can we add two rational expressions?", options: ["Always", "Only if denominators are same", "Never", "Only if numerators are same"], correct: 1 },
        { question: "Multiplying two rational expressions requires:", options: ["Adding numerators and denominators", "Multiplying numerators and denominators", "Subtracting numerators and denominators", "Finding LCM"], correct: 1 },
        { question: "Reducing a rational expression to lowest terms requires:", options: ["Adding terms", "Dividing numerator by denominator", "Factoring numerator and denominator", "None of the above"], correct: 2 }
    ]
};
