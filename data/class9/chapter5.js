...
const class9Chapter5 = {
    ...
    broad: [
        { question: "Define polynomial and its types.", answer: "A polynomial is an algebraic expression of variables and coefficients using only +, −, ×. Types: Monomial (1 term), Binomial (2 terms), Trinomial (3 terms)." },
        { question: "What is the degree of a polynomial?", answer: "The highest power of the variable present in the polynomial is called its degree." },
        { question: "Explain factor theorem and remainder theorem.", answer: "Factor theorem: If f(a)=0, then (x−a) is a factor of f(x). Remainder theorem: Remainder when f(x) is divided by (x−a) is f(a)." },
        { question: "What are zeroes of a polynomial?", answer: "The values of x that satisfy f(x)=0 are called the zeroes of the polynomial." },
        { question: "What are polynomial identities?", answer: "Equations true for all values of the variable, e.g., (a+b)² = a² + 2ab + b²." },
        { question: "State real-life applications of polynomials.", answer: "Polynomials are used in physics equations, economics, population growth, engineering models, etc." }
    ],
    broadTest: [
        { question: "What are the types of polynomials based on number of terms?", options: ["Monomial, Binomial, Trinomial", "Linear, Quadratic, Cubic", "Factorial, Exponential, Rational", "Constant, Variable, Coefficient"], correct: 0 },
        { question: "Which theorem states that if f(a)=0, then (x-a) is a factor of f(x)?", options: ["Remainder Theorem", "Factor Theorem", "Division Algorithm", "Identity Theorem"], correct: 1 },
        { question: "Polynomial identities are:", options: ["Equations true for specific values of variables", "Equations true for all values of variables", "Equations with only one solution", "Equations without variables"], correct: 1 },
        { question: "Which operation requires combining like terms after multiplying each term?", options: ["Addition", "Subtraction", "Multiplication", "Division"], correct: 2 },
        { question: "Real-life use of polynomials is seen in:", options: ["Algebraic modeling", "Physics equations", "Economics calculations", "All of the above"], correct: 3 }
    ]
};
