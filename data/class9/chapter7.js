...
const class9Chapter7 = {
    ...
    broad: [
        { question: "Define linear equation in two variables.", answer: "An equation of the form ax + by + c = 0, where a, b, c are constants and x, y are variables." },
        { question: "Explain the solution of a linear equation in two variables.", answer: "Pairs of values (x, y) that satisfy the equation." },
        { question: "Methods to solve a system of two linear equations.", answer: "Substitution method, elimination method, and cross-multiplication method." },
        { question: "Define consistent, inconsistent, dependent, and independent systems.", answer: "Consistent: at least one solution; Inconsistent: no solution; Dependent: infinitely many solutions; Independent: exactly one solution." },
        { question: "How to find the slope of a line?", answer: "Slope = −a/b for line ax + by + c = 0." },
        { question: "Find x-intercept and y-intercept of a line.", answer: "Set y=0 to find x-intercept, set x=0 to find y-intercept." },
        { question: "Practical applications of linear equations in two variables.", answer: "Used in business, economics, geometry, and modeling real-life situations." }
    ],
    broadTest: [
        { question: "Equation x + y − 5 = 0 is linear in:", options: ["One variable", "Two variables", "Three variables", "None"], correct: 1 },
        { question: "A solution of 2x + 3y = 6 is:", options: ["(1,1)", "(2,0)", "(0,2)", "(3,0)"], correct: 0 },
        { question: "Parallel lines have:", options: ["No solution", "One solution", "Infinite solutions", "Two solutions"], correct: 0 },
        { question: "Coincident lines have:", options: ["No solution", "One solution", "Infinite solutions", "Two solutions"], correct: 2 },
        { question: "Slope of 3x − 2y + 6 = 0 is:", options: ["3/2", "−3/2", "2/3", "−2/3"], correct: 3 }
    ]
};
